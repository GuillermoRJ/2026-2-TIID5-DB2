...
INSERT INTO medicos VALUES ('AJH','Jiménez Hernández','Antonio',7),('CEM','Esteban Muñoz','Carmen',8),('CSM','Sánchez Martínez','Carlos',3),('ESMH','Martín Hernández','Eva',7),('FHL','Hernández López','Fernanda',9),('FVP','Vidal Planella','Federico',1),('JMP','Moreno Navarro','Juana',5),('OPA','Pons Álvarez','Olga',5),('PAP','Armengol Prats','Pedro',2),('SGM','Gutiérrez Mellado','Sebastián',6),('SVT','Vázquez Torres','Santiago',4);
